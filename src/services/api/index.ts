...
export const bulkUpdateDoctorSchedules = (
    ...
    return axios.default.post(`/api/DoctorSchedules/Bulk/${doctorId}`, doctorSchedule, options);
};
...
>(options?: {
    mutation?: UseMutationOptions<
        ...
        TError,
        { doctorId: number; data: DoctorSchedule[] },
        TContext
    >;
    axios?: AxiosRequestConfig;
}): UseMutationOptions<
...
export type BulkUpdateDoctorSchedulesMutationResult = NonNullable<
    Awaited<ReturnType<typeof bulkUpdateDoctorSchedules>>
>;
export type BulkUpdateDoctorSchedulesMutationBody = DoctorSchedule[];
