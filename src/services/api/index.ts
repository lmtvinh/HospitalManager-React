...
export const getAppointment = (id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<AppointmentDTO>> => {
...
export const makeAppointment = (
    ...
    return axios.default.post(`/api/Appointments/Make`, makeAppointmentRequest, options);
};

export const getMakeAppointmentMutationOptions = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof makeAppointment>>,
        TError,
...
> => {
    ...
    > = (props) => {
        ...
        return makeAppointment(data, axiosOptions);
    };

    return { mutationFn, ...mutationOptions };
};

export type MakeAppointmentMutationResult = NonNullable<Awaited<ReturnType<typeof makeAppointment>>>;
export type MakeAppointmentMutationBody = MakeAppointmentRequest;
export type MakeAppointmentMutationError = AxiosError<unknown>;

export const useMakeAppointment = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof makeAppointment>>,
        TError,
        { data: MakeAppointmentRequest },
    ...
    TContext
> => {
    const mutationOptions = getMakeAppointmentMutationOptions(options);
...
export const updateAppointmentStatus = (
    ...
    return axios.default.patch(`/api/Appointments/${id}/status`, statusRequest, options);
};

export const getUpdateAppointmentStatusMutationOptions = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
...
> => {
    ...
    > = (props) => {
        ...
        return updateAppointmentStatus(id, data, axiosOptions);
    };
...
export type UpdateAppointmentStatusMutationBody = StatusRequest;
export type UpdateAppointmentStatusMutationError = AxiosError<unknown>;

export const useUpdateAppointmentStatus = <TError = AxiosError<unknown>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
        Awaited<ReturnType<typeof updateAppointmentStatus>>,
        TError,
        { id: number; data: StatusRequest },
...
export const getFreeDoctors = (
    params?: GetFreeDoctorsParams,
    options?: AxiosRequestConfig
): Promise<AxiosResponse<DoctorDTO[]>> => {
    return axios.default.get(`/api/DoctorSchedules/FreeDoctors`, {
        ...options,
        params: { ...params, ...options?.params },
    });
};

export const getGetFreeDoctorsQueryKey = (params?: GetFreeDoctorsParams) => {
    return [`/api/DoctorSchedules/FreeDoctors`, ...(params ? [params] : [])] as const;
};

export const getGetFreeDoctorsQueryOptions = <
    TData = Awaited<ReturnType<typeof getFreeDoctors>>,
    TError = AxiosError<unknown>,
>(
    params?: GetFreeDoctorsParams,
    options?: {
        query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getFreeDoctors>>, TError, TData>>;
        axios?: AxiosRequestConfig;
    }
) => {
    const { query: queryOptions, axios: axiosOptions } = options ?? {};

    const queryKey = queryOptions?.queryKey ?? getGetFreeDoctorsQueryKey(params);

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getFreeDoctors>>> = ({ signal }) =>
        getFreeDoctors(params, { signal, ...axiosOptions });

    return { queryKey, queryFn, ...queryOptions } as UseQueryOptions<
        Awaited<ReturnType<typeof getFreeDoctors>>,
        TError,
        TData
    > & { queryKey: DataTag<QueryKey, TData> };
};

export type GetFreeDoctorsQueryResult = NonNullable<Awaited<ReturnType<typeof getFreeDoctors>>>;
export type GetFreeDoctorsQueryError = AxiosError<unknown>;

export function useGetFreeDoctors<TData = Awaited<ReturnType<typeof getFreeDoctors>>, TError = AxiosError<unknown>>(
    params: undefined | GetFreeDoctorsParams,
    options: {
        query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getFreeDoctors>>, TError, TData>> &
            Pick<DefinedInitialDataOptions<Awaited<ReturnType<typeof getFreeDoctors>>, TError, TData>, 'initialData'>;
        axios?: AxiosRequestConfig;
    }
): DefinedUseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData> };
export function useGetFreeDoctors<TData = Awaited<ReturnType<typeof getFreeDoctors>>, TError = AxiosError<unknown>>(
    ...
    options?: {
        query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getFreeDoctors>>, TError, TData>> &
            Pick<UndefinedInitialDataOptions<Awaited<ReturnType<typeof getFreeDoctors>>, TError, TData>, 'initialData'>;
        axios?: AxiosRequestConfig;
    }
): UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData> };
export function useGetFreeDoctors<TData = Awaited<ReturnType<typeof getFreeDoctors>>, TError = AxiosError<unknown>>(
...
export function useGetFreeDoctors<TData = Awaited<ReturnType<typeof getFreeDoctors>>, TError = AxiosError<unknown>>(
    ...
    const queryOptions = getGetFreeDoctorsQueryOptions(params, options);
...
export const getPatientAppointments = (
    ...
    return axios.default.get(`/api/Patients/${id}/Appointments`, {
        ...options,
        params: { ...params, ...options?.params },
    });
};

export const getGetPatientAppointmentsQueryKey = (id: number, params?: GetPatientAppointmentsParams) => {
    return [`/api/Patients/${id}/Appointments`, ...(params ? [params] : [])] as const;
};
...
>(
    ...
    params?: GetPatientAppointmentsParams,
    options?: {
        query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getPatientAppointments>>, TError, TData>>;
        axios?: AxiosRequestConfig;
    }
) => {
    const { query: queryOptions, axios: axiosOptions } = options ?? {};

    const queryKey = queryOptions?.queryKey ?? getGetPatientAppointmentsQueryKey(id, params);

    const queryFn: QueryFunction<Awaited<ReturnType<typeof getPatientAppointments>>> = ({ signal }) =>
        getPatientAppointments(id, params, { signal, ...axiosOptions });
...
export type GetPatientAppointmentsQueryError = AxiosError<unknown>;
...
>(
    id: number,
    params: undefined | GetPatientAppointmentsParams,
    options: {
        query: Partial<UseQueryOptions<Awaited<ReturnType<typeof getPatientAppointments>>, TError, TData>> &
            Pick<
                DefinedInitialDataOptions<Awaited<ReturnType<typeof getPatientAppointments>>, TError, TData>,
                'initialData'
            >;
        axios?: AxiosRequestConfig;
    }
...
>(
    ...
    options?: {
        query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getPatientAppointments>>, TError, TData>> &
            Pick<
                UndefinedInitialDataOptions<Awaited<ReturnType<typeof getPatientAppointments>>, TError, TData>,
                'initialData'
            >;
        axios?: AxiosRequestConfig;
    }
